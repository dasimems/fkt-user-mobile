...
export const redColor: ColorType = {
  ...
  opacity10: "rgba(220, 38, 38,.01)",
  opacity20: "rgba(220, 38, 38,.02)",
  opacity30: "rgba(220, 38, 38,.03)",
  opacity40: "rgba(220, 38, 38,.04)",
  opacity50: "rgba(220, 38, 38,.05)",
  opacity60: "rgba(220, 38, 38,.06)",
  opacity70: "rgba(220, 38, 38,.07)",
  opacity80: "rgba(220, 38, 38,.08)",
  opacity90: "rgba(220, 38, 38,.09)",
...
export const pendingColor: ColorType = {
  ...
  opacity20: "rgba(249, 115, 22, .02)",
  opacity30: "rgba(249, 115, 22, .03)",
  opacity40: "rgba(249, 115, 22, .04)",
  opacity50: "rgba(249, 115, 22, .05)",
  opacity60: "rgba(249, 115, 22, .06)",
  opacity70: "rgba(249, 115, 22, .07)",
  opacity80: "rgba(249, 115, 22, .08)",
  opacity90: "rgba(249, 115, 22, .09)",
